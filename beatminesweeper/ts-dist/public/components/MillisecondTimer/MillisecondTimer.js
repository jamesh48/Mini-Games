...
export default () => {
    ...
    return (React.createElement("div", { className: 'milli-second-timer-container' },
        React.createElement("h4", { id: "milli-second-timer", className: skillLevel }, hours !== "00"
            ? `${hours} : ${minutes} : ${seconds} : ${centiseconds}`
            : minutes !== "00"
                ? `${minutes} : ${seconds} : ${centiseconds}`
                : `${seconds} : ${centiseconds}`)));
};
//# sourceMappingURL=MillisecondTimer.js.map